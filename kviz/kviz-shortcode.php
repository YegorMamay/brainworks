                            ...
                            <form action="javascript:void(null);" id="kvizForm" class="kviz-form" method="POST" >
                                <div class="kviz-slider">
    								...
    								<h3 class="kviz-slider__title">
                                            <?php _e('В який месенждер Вам зручно отримати результат?', 'brainworks') ?></h3>
                                                ...
                                                <div class="kviz-slider__form">
                                                    <div class="kviz-slider__content">
                                                        <div class="kviz-slider__data stopro">
                                                            <div class="kviz-slider__elem kviz-slider__elem-radio">
                                                                <input type="radio" name="messen" class="customRadio_radio"
                                                                       id="messen_1" value="Viber" data-title="Месенджер">
                                                            ...
                                                            <div class="kviz-slider__elem kviz-slider__elem-radio">
                                                                <input type="radio" name="messen" class="customRadio_radio"
                                                                       id="messen_2" value="Telegram" data-title="Месенджер">
                											...
                											<div class="kviz-slider__elem kviz-slider__elem-radio">
                                                                <input type="radio" name="messen" class="customRadio_radio"
                                                                       id="messen_3" value="Whatsapp" data-title="Месенджер">
                                                    ...
                                                    <div class="inputs_form">
                                                        <div class="main-input"><span class="icon-Phones"></span><input
                                                                ...
                                                                placeholder="Ваш номер телефону" name="yourPhone" required data-title="Телефон">
                                                        </div>
                                ...
                                <div class="btn--wrap kviz__btn-block">
                                    <button class=" btn-kviz prev-kviz" disabled="true">
                                        <span><?php _e('Назад', 'brainworks') ?></span>
                                    </button>
                                    <button class="btn-kviz next-kviz" disabled="true">
                                        <span><?php _e('Далее', 'brainworks') ?></span>
